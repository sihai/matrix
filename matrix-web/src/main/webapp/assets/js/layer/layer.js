...
Class.prototype.space = function(){
	...
	var zIndex = this.zIndex, shadeStyle = "z-index:"+ zIndex +"; background-color:"+ config.shade[1] +"; opacity:"+ config.shade[0] +"; filter:'alpha(opacity="+ config.shade[0]*100 +")'; filter:alpha(opacity="+ config.shade[0]*100 +");";
	...
	var borderStyle = "z-index:"+ (zIndex-1) +";  background-color: "+ config.border[2] +"; opacity:"+ config.border[1] +"; filter:'alpha(opacity="+ config.border[1]*100 +")'; filter:alpha(opacity="+ config.border[1]*100 +"); top:-"+ config.border[0] +"px; left:-"+  config.border[0] +"px;";
